...
def get_data():
    ...
    if snake.pos[0] == apple.x and snake.pos[1] > apple.y:
        a0 = abs(snake.pos[0] - apple.x) + abs(snake.pos[1] - apple.y)
    else:
        a0 = 0

    if snake.pos[0] < apple.x and snake.pos[1] == apple.y:
        a1 = abs(snake.pos[0] - apple.x) + abs(snake.pos[1] - apple.y)
    else:
        a1 = 0

    if snake.pos[0] == apple.x and snake.pos[1] < apple.y:
        a2 = abs(snake.pos[0] - apple.x) + abs(snake.pos[1] - apple.y)
    else:
        a2 = 0

    if snake.pos[0] > apple.x and snake.pos[1] == apple.y:
        a3 = abs(snake.pos[0] - apple.x) + abs(snake.pos[1] - apple.y)
    else:
        a3 = 0

    for part in snake.body:
        if snake.pos[0] == part[0] and snake.pos[1] > part[1]:
            b0 = abs(snake.pos[0] - part[0]) + abs(snake.pos[1] - part[1])
            break
    else:
        b0 = 0
    ...
    for part in snake.body:
        if snake.pos[0] < part[0] and snake.pos[1] == part[1]:
            b1 = abs(snake.pos[0] - part[0]) + abs(snake.pos[1] - part[1])
            break
    else:
        b1 = 0
    ...
    for part in snake.body:
        if snake.pos[0] == part[0] and snake.pos[1] < part[1]:
            b2 = abs(snake.pos[0] - part[0]) + abs(snake.pos[1] - part[1])
            break
    else:
        b2 = 0
    ...
    for part in snake.body:
        if snake.pos[0] > part[0] and snake.pos[1] == part[1]:
            b3 = abs(snake.pos[0] - part[0]) + abs(snake.pos[1] - part[1])
            break
    else:
        b3 = 0
...
class Game:
    ...
    def play(self):
        ...
        while True:
            ...
            snake.x_change_old, snake.y_change_old = snake.pos[0], snake.pos[1]
    ...
    while 1:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                game.d.fill((255, 69, 0))
                main_menu_message = font.render('start the game', True, (0, 0, 0))
